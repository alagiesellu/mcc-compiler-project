...
public class ASTIdentityTransformation extends ASTVisitor {
	...
	private String binaryOperator(String lexem, int priority, ASTExpression op1, ASTExpression op2, String indent) {
		if (op1.priority > priority && op2.priority > priority) {
			return "(" + op1.accept(this, indent) + ")    " + lexem + " (" + op2.accept(this, indent) + ")";
	...
	private String unaryOperator(String lexem, int priority, ASTExpression op, String indent) {
	...
	public Object visitAdd(ASTAdd add, Object indent) {
		return binaryOperator("+", add.priority, add.op1, add.op2, (String) indent);
	}

	@Override
	public Object visitAnd(ASTAnd and, Object indent) {
		return binaryOperator("&&", and.priority, and.op1, and.op2, (String) indent);
	}

	/* Our Implementation here */

	@Override
	public Object visitExpressionStatement(ASTExpressionStatement expressionStatement, Object indent) {

		String s = (String) indent;
		if (expressionStatement.variable != null)
			s += expressionStatement.variable.accept(this, "") + " = ";

		if (expressionStatement.expression != null)
			s += expressionStatement.expression.accept(this, "");

		if (expressionStatement.expressionS != null)
			s += expressionStatement.expressionS.accept(this, "");

		if (expressionStatement.flag)
			s += ";\n";
	...
	public Object visitBlock(ASTBlockStatement block, Object indent) {
		...
		for (int i = 0; i < block.varDeclarations.size(); i++) {
			s += block.varDeclarations.elementAt(i).accept(this, indent + "  ");
		}
	...
	public Object visitDiv(ASTDiv div, Object indent) {
		return binaryOperator("/", div.priority, div.op1, div.op2, (String) indent);
	}

	@Override
	public Object visitEq(ASTEq eq, Object indent) {
		return binaryOperator("==", eq.priority, eq.op1, eq.op2, (String) indent);
	}

	@Override
	public Object visitFunDeclaration(ASTFunDeclaration funDeclaration, Object indent) {
	...
	public Object visitGe(ASTGe ge, Object indent) {
		return binaryOperator(">=", ge.priority, ge.op1, ge.op2, (String) indent);
	}

	@Override
	public Object visitGt(ASTGt gt, Object indent) {
		return binaryOperator(">", gt.priority, gt.op1, gt.op2, (String) indent);
	}

	@Override
	public Object visitIfStatement(ASTIfStatement ifStatement, Object indent) {
		String s = indent + "if " + "(" + ifStatement.expression.accept(this, "") + ") ";
		...
		if (ifStatement.elseStatement != null) {
			if (ifStatement.elseStatement instanceof ASTBlockStatement) {
				...
				s += indent + "else " + ifStatement.elseStatement.accept(this, "");
			}
		} else {
			if (ifStatement.thenStatement instanceof ASTBlockStatement) {
				s += "\n";
	...
	@Override
	public Object visitIntegerConstant(ASTIntegerConstant integerConstant, Object indent) {
		return "" + integerConstant.value;
	}

	@Override
	public Object visitLe(ASTLe le, Object indent) {
		return binaryOperator("<=", le.priority, le.op1, le.op2, (String) indent);
	}

	@Override
	public Object visitLt(ASTLt lt, Object indent) {
		return binaryOperator("<", lt.priority, lt.op1, lt.op2, (String) indent);
	}

	@Override
	public Object visitMul(ASTMul mul, Object indent) {
		if (mul.op1.priority > 2 && mul.op2.priority > 2) {
			return "(" + mul.op1.accept(this, indent) + ") * (" + mul.op2.accept(this, indent) + ")";
	...
	public Object visitNe(ASTNe ne, Object indent) {
		return binaryOperator("!=", ne.priority, ne.op1, ne.op2, (String) indent);
	}
	...
	public Object visitOr(ASTOr or, Object indent) {
		return binaryOperator("||", or.priority, or.op1, or.op2, (String) indent);
	}

	@Override
	public Object visitParDeclaration(ASTParDeclaration parDeclaration, Object indent) {
		return "int " + parDeclaration.name;
	}

	@Override
	public Object visitPrintStatement(ASTPrintStatement printStatement, Object indent) {
		return ((String) indent) + "print(" + printStatement.expression.accept(this, "") + ");\n";
	}
	...
	@Override
	public Object visitReturnStatement(ASTReturnStatement returnStatement, Object indent) {
		return ((String) indent) + "return " + returnStatement.expression.accept(this, "") + ";\n";
	}

	@Override
	public Object visitSub(ASTSub sub, Object indent) {
		return binaryOperator("-", sub.priority, sub.op1, sub.op2, (String) indent);
	}

	@Override
	public Object visitVarDeclaration(ASTVarDeclaration varDeclaration, Object indent) {
	...
	@Override
	public Object visitWhileStatement(ASTWhileStatement whileStatement, Object indent) {
		String s = indent + "while " + "(" + whileStatement.expression.accept(this, "") + ") ";
	...
	@Override
	public Object visitBreakStatement(ASTBreakStatement breakStatement, Object indent) {
		return indent + "break;\n";
	}

	@Override
	public Object visitContinueStatement(ASTContinueStatement continueStatement, Object indent) {
