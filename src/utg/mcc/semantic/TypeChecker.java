...
public class TypeChecker extends ASTVisitor {
	...
	public Object visitAdd(ASTAdd add, Object o) {
		...
		if (!Type.checkType(IntType.intType(), t1, t2)) {
			throw new RuntimeException("incompatible types near " + add.position);
		}
		m.d();
		m.verbose("< add");
		return t1;
	...
	public Object visitAnd(ASTAnd and, Object o) {
		...
		if (!Type.checkType(BoolType.boolType(), t1, t2)) {
			throw new RuntimeException("incompatible types near " + and.position);
		}
		m.d();
		m.verbose("< and");
		return t1;
	...
	@Override
	public Object visitExpressionStatement(ASTExpressionStatement expressionStatement, Object o) {
		m.verbose("> express");
		m.i();

		if (expressionStatement.variable != null) {
			Type t1 = (Type) expressionStatement.variable.accept(this, null);
			if (!Type.checkType(IntType.intType(), t1)) {
				throw new RuntimeException("incompatible types near " + expressionStatement.position);
			}
		}

		if (expressionStatement.expression != null) {
			Type t2 = (Type) expressionStatement.expression.accept(this, null);
			if (!Type.checkType(IntType.intType(), t2)) {
				throw new RuntimeException("incompatible types near " + expressionStatement.position);
			}
		}
	...
	public Object visitCall(ASTCall call, Object o) {
		...
		for (int i = 0; i < call.parameters.size(); i++) {
			...
			if (!Type.checkType(fType, t)) {
				throw new RuntimeException("incompatible types near " + call.position);
			}
	...
	public Object visitDiv(ASTDiv div, Object o) {
		...
		if (!Type.checkType(IntType.intType(), t1, t2)) {
			throw new RuntimeException("incompatible types near " + div.position);
		}
		m.d();
		m.verbose("< div");
		return t1;
	...
	public Object visitEq(ASTEq eq, Object o) {
		...
		if (!Type.checkType(IntType.intType(), t1, t2)) {
			throw new RuntimeException("incompatible types near " + eq.position);
		}
		m.d();
		m.verbose("< eq");
	...
	@Override
	public Object visitFunDeclaration(ASTFunDeclaration funDeclaration, Object o) {
		...
		for (int i = 0; i < funDeclaration.parameters.size(); i++) {
			ASTParDeclaration declaration = funDeclaration.parameters.elementAt(i);
	...
	public Object visitGe(ASTGe ge, Object o) {
		...
		if (!Type.checkType(IntType.intType(), t1, t2)) {
			throw new RuntimeException("incompatible types near " + ge.position);
		}
		m.d();
		m.verbose("< ge");
		return BoolType.boolType();
	...
	public Object visitGt(ASTGt gt, Object o) {
		...
		if (!Type.checkType(IntType.intType(), t1, t2)) {
			throw new RuntimeException("incompatible types near " + gt.position);
		}
		m.d();
		m.verbose("< gt");
		return BoolType.boolType();
	...
	public Object visitIfStatement(ASTIfStatement ifStatement, Object o) {
		...
		if (!Type.checkType(BoolType.boolType(), t)) {
			throw new RuntimeException("incompatible types near " + ifStatement.expression.position);
		}
	...
	@Override
	public Object visitIntegerConstant(ASTIntegerConstant integerConstant, Object o) {
	...
	public Object visitLe(ASTLe le, Object o) {
		...
		if (!Type.checkType(IntType.intType(), t1, t2)) {
			throw new RuntimeException("incompatible types near " + le.position);
		}
		m.d();
		m.verbose("< le");
		return BoolType.boolType();
	...
	public Object visitLt(ASTLt lt, Object o) {
		...
		if (!Type.checkType(IntType.intType(), t1, t2)) {
			throw new RuntimeException("incompatible types near " + lt.position);
		}
		m.d();
		m.verbose("< lt");
		return BoolType.boolType();
	...
	public Object visitMul(ASTMul mul, Object o) {
		...
		if (!Type.checkType(IntType.intType(), t1, t2)) {
			throw new RuntimeException("incompatible types near " + mul.position);
		}
		m.d();
		m.verbose("< mul");
		return t1;
	...
	public Object visitNe(ASTNe ne, Object o) {
		...
		if (!Type.checkType(IntType.intType(), t1, t2)) {
			throw new RuntimeException("incompatible types near " + ne.position);
		}
		m.d();
		m.verbose("< ne");
		return BoolType.boolType();
	...
	public Object visitNot(ASTNot not, Object o) {
		...
		if (!Type.checkType(BoolType.boolType(), t)) {
			throw new RuntimeException("incompatible types near " + not.position);
		}
		m.d();
		m.verbose("< not");
		return t;
	...
	public Object visitOr(ASTOr or, Object o) {
		...
		if (!Type.checkType(BoolType.boolType(), t1, t2)) {
			throw new RuntimeException("incompatible types near " + or.position);
		}
		m.d();
		m.verbose("< or");
		return BoolType.boolType();
	...
	@Override
	public Object visitParDeclaration(ASTParDeclaration parDeclaration, Object o) {
	...
	@Override
	public Object visitPrintStatement(ASTPrintStatement printStatement, Object o) {
		m.verbose("> print");
		m.i();
	...
	@Override
	public Object visitReturnStatement(ASTReturnStatement returnStatement, Object o) {
		m.verbose("> return");
		m.i();
		Type t = null;
		Type type = null;
		if (returnStatement.expression.expression != null) {
			t = (Type) returnStatement.expression.expression.accept(this, null);
			type = returnStatement.entry.type.returnType;
			if (!Type.checkType(t, type)) {
				throw new RuntimeException("incompatible types near " + returnStatement.position);
			}
		}
		if (returnStatement.expression.expressionS != null) {
			t = (Type) returnStatement.expression.expressionS.accept(this, null);
			type = returnStatement.entry.type.returnType;
			if (!Type.checkType(t, type)) {
				throw new RuntimeException("incompatible types near " + returnStatement.position);
			}
	...
	public Object visitSub(ASTSub sub, Object o) {
		...
		if (!Type.checkType(IntType.intType(), t1, t2)) {
			throw new RuntimeException("incompatible types near " + sub.position);
		}
		m.d();
		m.verbose("< sub");
		return t1;
	...
	@Override
	public Object visitVarDeclaration(ASTVarDeclaration varDeclaration, Object o) {
	...
	@Override
	public Object visitWhileStatement(ASTWhileStatement whileStatement, Object o) {
		m.verbose("> while");
		m.i();
		Type t = (Type) whileStatement.expression.accept(this, null);
		if (!Type.checkType(BoolType.boolType(), t)) {
			throw new RuntimeException("incompatible types near " + whileStatement.expression.position);
		}
	...
	public Object visitForStatement(ASTForStatement forStatement, Object o) {
		...
		Type type_i = (Type) forStatement.initialization.accept(this, null);
		...
		Type type_u = (Type) forStatement.update.accept(this, null);
	...
	@Override
	public Object visitBreakStatement(ASTBreakStatement breakStatement, Object string) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Object visitContinueStatement(ASTContinueStatement breakStatement, Object string) {
		// TODO Auto-generated method stub
		return null;
	}
}
