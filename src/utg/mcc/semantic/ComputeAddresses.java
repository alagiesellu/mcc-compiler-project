...
public class ComputeAddresses extends ASTVisitor {
	...
	/**
	 * during the first pass, the visitor will analyse all top variable declarations
	 * and function declarations (without body) thus detecting recursive symbols
	 * that could cause problems during the analysis. during the second pass, all
	 * blocks will be analysed
	 */
	private int pass = 1;
	...
	public Object visitExpressionStatement(ASTExpressionStatement expressionStatement, Object o) {
		...
		if (expressionStatement.variable != null)
			expressionStatement.variable.accept(this, null);
		...
		if (expressionStatement.expressionS != null)
			expressionStatement.expressionS.accept(this, null);
	...
	public Object visitCall(ASTCall call, Object o) {
		...
		if (entry == null) {
			throw new RuntimeException("function " + call.name + " at " + call.position + " has not been declared");
		}
	...
	public Object visitVariable(ASTVariable variable, Object o) {
		...
		if (entry == null) {
			throw new RuntimeException(
					"variable " + variable.name + " at " + variable.position + " has not been declared");
		}
