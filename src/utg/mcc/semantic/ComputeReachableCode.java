...
public class ComputeReachableCode extends ASTVisitor {
	...
	public Object visitExpressionStatement(ASTExpressionStatement expressionStatement, Object o) {
		...
		if (!reachable) {
			m.error("unreachable statement at " + expressionStatement.position + "\n" + expressionStatement);
		}
	...
	public Object visitBlock(ASTBlockStatement block, Object o) {
		...
		for (int i = 0; i < block.statements.size(); i++) {
			boolean hr = (Boolean) block.statements.elementAt(i).accept(this, reachable);
	...
	public Object visitIfStatement(ASTIfStatement ifStatement, Object o) {
		...
		hasReturnT = (Boolean) ifStatement.thenStatement.accept(this, reachable);
		if (ifStatement.elseStatement != null) {
			hasReturnE = (Boolean) ifStatement.elseStatement.accept(this, reachable);
		}
	...
	public Object visitProgram(ASTProgram program, Object o) {
		...
		for (int i = 0; i < program.statements.size(); i++) {
			...
			boolean hr = (Boolean) program.statements.elementAt(i).accept(this, reachable);
	...
	public Object visitReturnStatement(ASTReturnStatement returnStatement, Object o) {
		boolean reachable = (Boolean) o;
		if (!insideFunction) {
			m.error("illegal return statement at " + returnStatement.position);
