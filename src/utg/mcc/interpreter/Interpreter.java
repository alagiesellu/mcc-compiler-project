...
public class Interpreter extends ASTVisitor {
	...
	public Object visitAdd(ASTAdd add, Object o) {
		m.verbose("> add");
		m.i();
		int r = (Integer) add.op1.accept(this, o) + (Integer) add.op2.accept(this, o);
		m.d();
		m.verbose("< add [" + r + "]");
		return r;
	}
	...
	public Object visitAnd(ASTAnd and, Object o) {
		m.verbose("> and");
		m.i();
		int r = (Integer) and.op1.accept(this, o) * (Integer) and.op2.accept(this, o);
		m.d();
		m.verbose("< and [" + r + "]");
		return r;
	}
	...
	public Object visitCall(ASTCall call, Object o) {
		...
		for (int i = 0; i < call.parameters.size(); i++) {
			Integer v = (Integer) call.parameters.elementAt(i).accept(this, o);
			memory.put(i, v);
		}
	...
	public Object visitDiv(ASTDiv div, Object o) {
		m.verbose("> div");
		m.i();
		int r = (Integer) div.op1.accept(this, o) / (Integer) div.op2.accept(this, o);
		m.d();
		m.verbose("< div [" + r + "]");
		return r;
	}
	...
	public Object visitEq(ASTEq eq, Object o) {
		m.verbose("> eq");
		m.i();
		int r = ((Integer) eq.op1.accept(this, o) == (Integer) eq.op2.accept(this, o) ? 1 : 0);
		m.d();
		m.verbose("< eq [" + r + "]");
		return r;
	}
	...
	public Object visitGe(ASTGe ge, Object o) {
		m.verbose("> ge");
		m.i();
		int r = ((Integer) ge.op1.accept(this, o) >= (Integer) ge.op2.accept(this, o) ? 1 : 0);
		m.d();
		m.verbose("< ge [" + r + "]");
		return r;
	}
	...
	public Object visitGt(ASTGt gt, Object o) {
		m.verbose("> gt");
		m.i();
		int r = ((Integer) gt.op1.accept(this, o) > (Integer) gt.op2.accept(this, o) ? 1 : 0);
		m.d();
		m.verbose("< gt [" + r + "]");
		return r;
	}
	...
	public Object visitLe(ASTLe le, Object o) {
		m.verbose("> le");
		m.i();
		int r = ((Integer) le.op1.accept(this, o) <= (Integer) le.op2.accept(this, o) ? 1 : 0);
		m.d();
		m.verbose("< le [" + r + "]");
		return r;
	}
	...
	public Object visitLt(ASTLt lt, Object o) {
		m.verbose("> lt");
		m.i();
		int r = ((Integer) lt.op1.accept(this, o) < (Integer) lt.op2.accept(this, o) ? 1 : 0);
		m.d();
		m.verbose("< lt [" + r + "]");
		return r;
	}
	...
	public Object visitMul(ASTMul mul, Object o) {
		m.verbose("> mul");
		m.i();
		int r = (Integer) mul.op1.accept(this, o) * (Integer) mul.op2.accept(this, o);
		m.d();
		m.verbose("< mul [" + r + "]");
		return r;
	}
	...
	public Object visitNe(ASTNe ne, Object o) {
		m.verbose("> ne");
		m.i();
		int r = ((Integer) ne.op1.accept(this, o) != (Integer) ne.op2.accept(this, o) ? 1 : 0);
		m.d();
		m.verbose("< ne [" + r + "]");
		return r;
	}
	...
	public Object visitOr(ASTOr or, Object o) {
		m.verbose("> or");
		m.i();
		int r = (Integer) or.op1.accept(this, o) + (Integer) or.op2.accept(this, o);
		if (r == 2) {
			r = 1;
		}
		m.d();
	...
	public Object visitSub(ASTSub sub, Object o) {
		...
		m.i();
		int r = 0;
		r = (Integer) sub.op1.accept(this, o) - (Integer) sub.op2.accept(this, o);
		m.d();
		m.verbose("< sub [" + r + "]");
		return r;
	}
	...
	public Object visitExpressionStatement(ASTExpressionStatement expressionStatement, Object o) {
		m.verbose("> express");
		m.i();
		int r = (Integer) expressionStatement.expression.accept(this, o);
		if(expressionStatement.variable != null) {
			memory.put(expressionStatement.variable.entry.address, r);
		}
		m.d();
		m.verbose("< express [" + r + "]");
		return r;
	...
	public Object visitForStatement(ASTForStatement forStatement, Object o) {
		...
		m.i();
		int r = 0;
		for(forStatement.initialization.accept(this, o); (Integer)(forStatement.expression.accept(this, o)) != 0;
				forStatement.update.accept(this, o)) {
			if (!returned) {
				r = (Integer) forStatement.statement.accept(this, o);
			}
		}
		m.d();
		m.verbose("< for [" + r + "]");
	...
	@Override
	public Object visitContinueStatement(ASTContinueStatement continueStatement, Object string) {
		// TODO Auto-generated method stub
		return null;
	}
}
