...
import utg.mcc.parser.NakedParser;
...
public class Main {
	...
	public static void main(String[] args) throws FileNotFoundException, ParseException {
		...
		/*
		 * new NakedParser(new FileReader(new File(
		 * "/home/sellu/Downloads/Software/WorkSpace/Compiler/mcc/src/workspace/factorial.int"
		 * ))); NakedParser.program(); m.message("done");
		 */

		new NakedParser(new FileReader(
				new File("/home/reds0n/eclipse-workspace/group/mcc/src/workspace/factorial.int")));

		m.message("parsing");
		ASTNode n = NakedParser.program();
		...
		/*
		 * m.message("compute reachable"); n.accept(new ComputeReachableCode(), true);
		 * m.message("interpreting"); Interpreter interpreter = new Interpreter();
		 * n.accept(interpreter, null); m.message("memory"); m.message("" +
		 * interpreter.memory); m.message("byte code generation"); n.accept(new
		 * TFByteCodeGenerator(args[0]), null); m.message("executing byte code");
		 * Exec.exec(); m.message("done");
		 */
